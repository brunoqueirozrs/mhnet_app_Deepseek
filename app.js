/**
 * ============================================================
 * MHNET VENDAS - LÓGICA V106 (FIX MATERIAIS & VISUAL)
 * ============================================================
 * 📝 UPDATE:
 * - Restaurado layout de cartões para Materiais (Img + Botões).
 * - Adicionada filtragem local para busca rápida de planos.
...
document.addEventListener('DOMContentLoaded', () => {
    console.log("🚀 MHNET App V106 - Materiais Visual");
...
// ============================================================
// 3. MATERIAIS & FILTROS (ATUALIZADO)
// ============================================================
        ...
        if (item.type === 'folder') {
            ...
            <div class="bg-white p-2 rounded-2xl shadow-sm border border-slate-100 flex flex-col h-auto relative overflow-hidden group">
                <div class="h-32 w-full bg-gray-50 rounded-xl overflow-hidden relative mb-2 bg-gray-100">
                    <img src="${item.thumbnail}" class="w-full h-full object-cover transition transform group-hover:scale-105" alt="${item.name}" loading="lazy" onerror="this.src='https://via.placeholder.com/150?text=IMG'">
                </div>
